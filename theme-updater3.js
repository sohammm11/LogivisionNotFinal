...
const replacements = [
  ...
  ['hover:bg-[#1E2D4550] transition-colors', 'hover:bg-slate-50 transition-all duration-200 hover:shadow-sm hover:-translate-y-[1px]'],
  ['border-b border-slate-200', 'border-b border-slate-100'],
  ['bg-[#0DD9B015]', 'bg-teal-50'],
  ['bg-slate-50/50', 'bg-slate-100'],
  
  // Update map marker icon to match light theme better (darker icon dot)
  ['bg-[#F59E0B]', 'bg-[#F59E0B]']
];
